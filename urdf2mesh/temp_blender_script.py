...
# 配置
input_folder = r'/Users/zhi/Documents/Scripts/BlenderAddons/urdf2mesh/Input'
output_folder = r'/Users/zhi/Documents/Scripts/BlenderAddons/urdf2mesh/Output'
checkpoint_file = os.path.join(output_folder, '.processing_checkpoint.json')
# UV投影参数（与官方API完全一致）
uv_angle_limit = 66.0          # Angle Limit（角度）
uv_island_margin = 0.0      # Island Margin
uv_area_weight = 0.0          # Area Weight
uv_correct_aspect = True    # Correct Aspect
uv_scale_to_bounds = False  # Scale to Bounds
